...
#define nIRQ        GPIO_ReadInputDataBit(nIRQ_PORT, nIRQ_PIN)
#define nGPIO2      GPIO_ReadInputDataBit(nGPIO2_PORT, nGPIO2_PIN)
...
extern BF_INT32U Get_Sign433_MasterAddr(void);//获取测试主机地址
extern BF_INT08U  Get_Sign433_TestPackNum(void);//获取测试报数量
